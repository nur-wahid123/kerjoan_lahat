<footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="https://adminlte.io">MegahMS</a>.</strong>
    All rights reserved.
...
<!-- jQuery UI 1.11.4 -->
<script src="../assets/assets_admin/plugins/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Sparkline -->
<script src="../assets/assets_admin/plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
<script src="../assets/assets_admin/plugins/jqvmap/jquery.vmap.min.js"></script>
<script src="../assets/assets_admin/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="../assets/assets_admin/plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="../assets/assets_admin/plugins/moment/moment.min.js"></script>
<script src="../assets/assets_admin/plugins/daterangepicker/daterangepicker.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="../assets/assets_admin/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
<script src="../assets/assets_admin/plugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
...
<script src="../assets/assets_admin/dist/js/pages/dashboard.js"></script>
...
<script src="../assets/assets_admin/plugins/datatables-buttons/js/buttons.colVis.min.js"></script>
<script>
    $(function() {
        $("#example1").DataTable({
            "responsive": true,
