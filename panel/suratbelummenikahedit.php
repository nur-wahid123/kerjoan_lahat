<?php
include 'header.php';
$ambildata = $koneksi->query("SELECT * FROM suratbelummenikah WHERE idsuratbelummenikah ='$_GET[id]'");
...
if (isset($_POST['simpan'])) {
    ...
    $koneksi->query("UPDATE suratbelummenikah SET nik='$nik',nik='$nik',nama='$nama',tempatlahir='$tempatlahir',tanggallahir='$tanggallahir',jeniskelamin='$jeniskelamin',agama='$agama',alamat='$alamat',pekerjaan='$pekerjaan',statusperkawinan='$statusperkawinan',status='$status',keterangansurat='$keterangansurat',scankk='$scankk',scanktp='$scanktp',kewarganegaraan='$_POST[kewarganegaraan]' WHERE idsuratbelummenikah='$_GET[id]'") or die(mysqli_error($koneksi));

    echo "<script>alert('Data Berhasil Di Simpan');</script>";
    echo "<script>location='suratbelummenikahedit.php?id=$_GET[id]';</script>";
}
?>
