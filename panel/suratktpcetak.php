...
<?php
include '../koneksi.php';
$ambildata = $koneksi->query("SELECT * FROM suratktp WHERE idsuratktp ='$_GET[id]'") or die(mysqli_error($koneksi));
$data = $ambildata->fetch_assoc();
$spasi = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
?>
<title>SURAT KETERANGAN / PENGANTAR KTP</title>
        ...
        <table width="625">
            <tr>
                <td colspan="2">
                    ...
                    <center>
                        <font size="4"><b>Nomor : <?= $data['idsuratktp'] ?>/<?= date('m') ?>/<?= date('Y') ?></b></font>
                    </center>
                </td>
            </tr>
        </table>
