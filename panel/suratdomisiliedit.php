<?php
include 'header.php';
$ambildata = $koneksi->query("SELECT * FROM suratdomisili WHERE idsuratdomisili ='$_GET[id]'");
...
if (isset($_POST['simpan'])) {
    ...
    $koneksi->query("UPDATE suratdomisili SET nik='$nik',nik='$nik',nama='$nama',tempatlahir='$tempatlahir',tanggallahir='$tanggallahir',jeniskelamin='$jeniskelamin',agama='$agama',alamat='$alamat',pekerjaan='$pekerjaan',statusperkawinan='$statusperkawinan',status='$status',keterangansurat='$keterangansurat',scankk='$scankk',scanktp='$scanktp' WHERE idsuratdomisili='$_GET[id]'") or die(mysqli_error($koneksi));

    echo "<script>alert('Data Berhasil Di Simpan');</script>";
    echo "<script>location='suratdomisiliedit.php?id=$_GET[id]';</script>";
}
?>
