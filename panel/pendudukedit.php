                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label for="kategori" class="mb-2">Status</label>
                                            <select class="form-control" name="statusaktif" required>
                                                <option <?php if ($data['statusaktif'] == 'Aktif') echo 'selected'; ?> value="Aktif">Aktif</option>
                                                <option <?php if ($data['statusaktif'] == 'Tidak Aktif') echo 'selected'; ?> value="Tidak Aktif">Tidak Aktif</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
...
if (isset($_POST['simpan'])) {
    ...
    echo "<script>location='pendudukdaftar.php';</script>";
}
?>
