                        ...
                        <div class="col-md-12">
                            <form method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="kewarganegaraan">No. Kartu Keluarga</label>
                                            <input type="number" class="form-control" name="nokk" value="<?= $data['nokk']; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
...
if (isset($_POST['simpan'])) {
    ...
    $koneksi->query("UPDATE suratktp SET status='$status',keterangan='$keterangan',tanggalberlaku='$_POST[tanggalberlaku]' WHERE idsuratktp='$_GET[id]'") or die(mysqli_error($koneksi));
