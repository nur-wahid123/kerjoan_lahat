...
<?php
include '../koneksi.php';
$ambildata = $koneksi->query("SELECT * FROM suratskck WHERE idsuratskck ='$_GET[id]'") or die(mysqli_error($koneksi));
$data = $ambildata->fetch_assoc();
$spasi = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
?>
<title>SURAT PENGANTAR SKCK</title>
<link rel="shortcut icon" type="image/x-icon" href="../assets/home/assets/img/logo/logobaru.png">
    ...
    <center>
        ...
        <table width="625">
            <tr>
                <td colspan="2">
                    <center>
                        <font size="4"><b><u>SURAT KETERANGAN / PENGANTAR</u></b></font>
                    </center>
                    <center>
                        <font size="4"><b>Nomor : <?= $data['idsuratskck'] ?>/<?= date('m') ?>/<?= date('Y') ?></b></font>
                    </center>
                </td>
            </tr>
        </table>
        ...
        <table width="625">
            <tr>
                <td>
                    <font size="2"><?= $spasi ?>Yang bertanda Tangan dibawah ini Kami Kepala Dukcapil Kabupaten Lahat Menerangkan Bahwa :</font>
                </td>
            </tr>
        </table>
        <table width="500">
            ...
            <tr>
                <td>Berlaku mulai</td>
                <td>: </td>
                <td>Tanggal <?= tanggal($data['tanggalberlaku']) ?> s/d Selesai</td>
            </tr>
            <tr>
                <td>Keterangan</td>
                <td>: </td>
                <td>
                    <?= $data['keterangansurat']; ?>
                </td>
            </tr>
        </table>
        <br>
        <table width="625">
            <tr>
                <td>
                    <?= $spasi ?>Demikian untuk menjadikan Maklum bagi yang berkepentingan.
                    </font>
                </td>
            </tr>
        </table>
