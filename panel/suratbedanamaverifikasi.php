                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="namasuratlain" value="<?= $data['namasuratlain']; ?>" placeholder="KTP / Kartu BPJS / KIS / Jamkesmas" readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="nama">Nama Lengkap Di Surat / Kartu Lain</label>
                                    <input type="text" class="form-control" name="namalain" value="<?= $data['namalain']; ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="tempatlahir">No. Surat Di Surat / Kartu Lain</label>
                                    <input type="number" class="form-control" name="nosuratlain" value="<?= $data['nosuratlain']; ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="alamat">Alamat Lengkap / Tempat Tinggal Di Surat / Kartu Lain</label>
                                    <textarea name="alamatlain" id="alamat" cols="30" rows="5" class="form-control" readonly><?= $data['alamatlain']; ?></textarea>
                                </div>
                            </div>
...
if (isset($_POST['simpan'])) {
    ...
    $koneksi->query("UPDATE suratbedanama SET status='$status',keterangan='$keterangan' WHERE idsuratbedanama='$_GET[id]'") or die(mysqli_error($koneksi));
