<?php
include 'header.php';
$ambildata = $koneksi->query("SELECT * FROM suratktp WHERE idsuratktp ='$_GET[id]'");
                        ...
                        <div class="col-md-12">
                            <form method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="kartukeluarga">No. Kartu Keluarga</label>
                                            <input type="number" class="form-control" name="nokk" value="<?= $data['nokk']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
...
if (isset($_POST['simpan'])) {
    ...
    $koneksi->query("UPDATE suratktp SET nik='$nik',nik='$nik',nama='$nama',tempatlahir='$tempatlahir',tanggallahir='$tanggallahir',jeniskelamin='$jeniskelamin',agama='$agama',alamat='$alamat',pekerjaan='$pekerjaan',statusperkawinan='$statusperkawinan',status='$status',keterangansurat='$keterangansurat',scankk='$scankk',kewarganegaraan='$_POST[kewarganegaraan]',nokk='$_POST[nokk]' WHERE idsuratktp='$_GET[id]'") or die(mysqli_error($koneksi));

    echo "<script>alert('Data Berhasil Di Simpan');</script>";
    echo "<script>location='suratktpedit.php?id=$_GET[id]';</script>";
}
?>
