...
if (isset($_POST['simpan'])) {
    ...
    if ($_FILES['scankk']['size'] <= $maxFileSize && $_FILES['scanktp']['size'] <= $maxFileSize) {
        ...
        $koneksi->query("INSERT INTO suratdomisili
		...
		VALUES('$iduser','$nik','$nama','$tempatlahir','$tanggallahir','$jeniskelamin','$agama','$alamat','$pekerjaan','$statusperkawinan','$status','$keterangansurat','$scankk','$scanktp','$kewarganegaraan')") or die(mysqli_error($koneksi));
