                        ...
                        <div class="col-md-12">
                            <form method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="pekerjaan">No. Kartu Keluarga</label>
...
if (isset($_POST['simpan'])) {
    ...
    if ($_FILES['scankk']['size'] <= $maxFileSize) {
    ...
    $koneksi->query("INSERT INTO suratktp
		(iduser,nik,nama,tempatlahir,tanggallahir,jeniskelamin,agama,alamat,pekerjaan,statusperkawinan,status,keterangansurat,scankk,kewarganegaraan,nokk)
		VALUES('$iduser','$nik','$nama','$tempatlahir','$tanggallahir','$jeniskelamin','$agama','$alamat','$pekerjaan','$statusperkawinan','$status','$keterangansurat','$scankk','$_POST[kewarganegaraan]','$_POST[nokk]')") or die(mysqli_error($koneksi));
